...
public class EducationProgramResource {
	...
	public EducationProgramDto create(@RequestParam("eduProgramRequestJson") String eduProgramRequestJson,
									@RequestPart("file") MultipartFile file) {
		EducationProgramRequestDto requestDto = Utility.convertStringJsonToObject(eduProgramRequestJson, 
