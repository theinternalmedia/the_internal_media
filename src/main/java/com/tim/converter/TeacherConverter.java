...
public class TeacherConverter extends AbstractConverter<TeacherDto, Teacher> {
	...
	public TeacherUpdateTeacherDto toDto(UserUpdateUserDto userDto) {
		return this.modelMapper.map(userDto, TeacherUpdateTeacherDto.class);
	}
	
	public Teacher toEntity(TeacherUpdateTeacherDto dto, Teacher entity) {
